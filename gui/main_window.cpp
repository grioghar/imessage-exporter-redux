...
void MainWindow::showGoogleSetup() {
    richTextDialog(
        ...
        "Console</a>; create or select a project.</li>"
        "<li><b>APIs &amp; Services → Library</b> → <b>People API</b> → "
        "<b>Enable</b>.</li>"
        "<li><b>APIs &amp; Services → OAuth consent screen</b> (opens Google Auth "
        "Platform → <b>Get started</b>):"
        "<ul>"
        "<li><b>Branding:</b> app name + your support/contact email.</li>"
